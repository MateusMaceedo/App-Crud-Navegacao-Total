...
<form action="/APP-CRUD-NAVEGACAO-TOTAL/FabricanteListar" class="row g-3" method="post">
	...
	<a class="btn btn-primary" href="/APP-CRUD-NAVEGACAO-TOTAL/Fabricante/New.jsp">Novo Fabricante</a>
</form>
<c:out value = "${msg}"/>
</div>
<div class="container-sm" align="center">
